...
online version: https://learn.microsoft.com/powershell/module/az.springcloud/set-azspringcloudcertificate
schema: 2.0.0
---

# Set-AzSpringCloudCertificate
...
```
Set-AzSpringCloudCertificate -Name <String> -ResourceGroupName <String> -ServiceName <String>
