...
online version: https://learn.microsoft.com/powershell/module/az.springcloud/set-azspringcloudbuildservicebuilder
schema: 2.0.0
---

# Set-AzSpringCloudBuildServiceBuilder
...
```
Set-AzSpringCloudBuildServiceBuilder -Name <String> -ResourceGroupName <String> -ServiceName <String>
