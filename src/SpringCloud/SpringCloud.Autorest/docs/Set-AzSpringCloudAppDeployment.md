...
online version: https://learn.microsoft.com/powershell/module/az.springcloud/set-azspringcloudappdeployment
schema: 2.0.0
---

# Set-AzSpringCloudAppDeployment
...
```
Set-AzSpringCloudAppDeployment -AppName <String> -Name <String> -ResourceGroupName <String>
