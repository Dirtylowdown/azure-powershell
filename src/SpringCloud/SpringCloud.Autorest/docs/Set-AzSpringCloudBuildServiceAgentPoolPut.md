...
online version: https://learn.microsoft.com/powershell/module/az.springcloud/set-azspringcloudbuildserviceagentpoolput
schema: 2.0.0
---

# Set-AzSpringCloudBuildServiceAgentPoolPut
...
```
Set-AzSpringCloudBuildServiceAgentPoolPut -AgentPoolName <String> -BuildServiceName <String>
 -ResourceGroupName <String> -ServiceName <String> [-SubscriptionId <String>] [-PoolSizeName <String>]
