...
online version: https://learn.microsoft.com/powershell/module/az.springcloud/set-azspringcloudappcustomdomain
schema: 2.0.0
---

# Set-AzSpringCloudAppCustomDomain
...
```
Set-AzSpringCloudAppCustomDomain -AppName <String> -Name <String> -ResourceGroupName <String>
