...
```
Update-AzSpringCloudAppActiveDeployment -Name <String> -ResourceGroupName <String> -ServiceName <String>
 [-SubscriptionId <String>] -ActiveDeploymentCollection <IActiveDeploymentCollection>
...
### SetViaIdentity
```
Update-AzSpringCloudAppActiveDeployment -InputObject <ISpringCloudIdentity>
 -ActiveDeploymentCollection <IActiveDeploymentCollection> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Parameter Sets: SetViaIdentitySpring, Set, SetViaIdentity
Aliases:
...
```yaml
Type: System.String
Parameter Sets: SetExpanded, SetViaJsonString, SetViaJsonFilePath, SetViaIdentitySpringExpanded, SetViaIdentitySpring, Set
Aliases:
...
```yaml
Type: System.String
Parameter Sets: SetExpanded, SetViaJsonString, SetViaJsonFilePath, Set
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.ISpringCloudIdentity
Parameter Sets: SetViaIdentitySpringExpanded, SetViaIdentitySpring
Aliases:
