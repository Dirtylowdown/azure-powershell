...
```
Get-AzSpringCloudBuildpackBinding -BuilderName <String> -Name <String>
 -BuildServiceInputObject <ISpringCloudIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: List, GetViaIdentitySpring, GetViaIdentityBuildService, Get
Aliases:
...
```yaml
Type: System.String
Parameter Sets: GetViaIdentitySpring, GetViaIdentityBuildService, Get, GetViaIdentityBuilder
